...
type Item = {
  ...
  focus: string[];
  impact: string[];
  phone: 'green' | 'sports' | 'tempo' | 'runway' | 'resume' | 'home';
  url: string;
};
...
const work: Item[] = [
  ...
  { company: 'Z4 Foundation', title: 'Web3 Agricultural Land Investment Platform', role: 'Frontend Developer', date: 'Collaborative product build', description: 'A Web3 platform on Solana that fractionalizes agricultural land ownership, opening land investment to smaller-scale investors through blockchain-based smart contracts.', focus: ['Frontend UI', 'Solana integration', 'Fractional ownership'], impact: ['Built investor-facing flows for blockchain-backed land assets', 'Translated a complex Web3 concept into a clearer product interface'], phone: 'sports', url: 'https://z4foundation.io/' },
...
const workId: Item[] = [
  ...
  { ...work[1], date: 'Pengembangan produk kolaboratif', description: 'Platform Web3 di Solana yang memecah kepemilikan lahan pertanian menjadi bagian kecil, membuka investasi lahan untuk investor skala kecil lewat smart contract.', focus: ['Frontend UI', 'Integrasi Solana', 'Kepemilikan fraksional'], impact: ['Membangun alur investor untuk aset lahan berbasis blockchain', 'Menerjemahkan konsep Web3 yang kompleks menjadi antarmuka produk yang lebih jelas'] },
  { ...work[2], description: 'Platform SaaS untuk mengelola operasional toko alat tulis — inventaris, penjualan, dan admin — dengan dashboard admin berbasis React.', impact: ['Membangun alur admin untuk inventaris, penjualan, dan operasional toko', 'Menghubungkan model data backend dengan dashboard yang praktis dipakai'] },
  { ...work[3], description: 'Perkakas command-line yang memberi tombol undo instan saat agen coding AI merusak codebase — rollback bertingkat, backup otomatis, dan audit log sebelum aksi destruktif.', impact: ['Merancang UX CLI untuk skenario yang kritis terhadap keamanan', 'Meneliti deteksi perubahan berisiko seperti dependency shift dan schema drift sebelum menimbulkan kerusakan'] },
];
