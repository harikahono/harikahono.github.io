...
const work: Item[] = [
  ...
  { company: 'Z4 Foundation', title: 'Web3 Agricultural Land Investment Platform', role: 'Frontend Developer', date: 'Community Web3 pilot', description: 'A Web3 platform on Solana that fractionalizes agricultural land ownership, opening land investment to smaller-scale investors through blockchain-based smart contracts.', focus: ['Frontend UI', 'Solana integration', 'Fractional ownership'], impact: ['Built investor-facing flows for blockchain-backed land assets', 'Translated a complex Web3 concept into a clearer product interface'], phone: 'sports', url: 'https://z4foundation.io/' },
