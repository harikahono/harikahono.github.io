...
const work: Item[] = [
  ...
  { company: 'Anugerah Printer', title: 'Company Profile Website', role: 'Frontend Developer', date: 'Printing business website', description: 'A service-first company profile for Anugerah Printer, a Jakarta-based printing business — redesigned from a marketplace-style catalog into a focused B2B website with dedicated service pages, portfolio filtering, WhatsApp quote intake, contact/location flow, and a production video hero.', focus: ['Vanilla HTML/CSS/JavaScript', 'Tailwind CDN', 'Static MPA architecture', 'WhatsApp quote flow', 'Portfolio gallery + lightbox', 'Leaflet map', 'Local SEO metadata'], impact: ['Replaced fake cart and checkout patterns with real consultation-first flows', 'Built dedicated service, portfolio, about, and contact pages', 'Created structured WhatsApp quote messages without backend storage', 'Improved trust with real address, opening hours, map, client logos, favicon set, schema metadata, and production video'], phone: 'anugerah', url: 'https://anugerahprinter.com/' },
...
const workId: Item[] = [
  ...
  { ...work[4], date: 'Website bisnis percetakan', description: 'Company profile service-first untuk Anugerah Printer, bisnis percetakan berbasis Jakarta — diubah dari katalog marketplace menjadi website B2B yang fokus ke halaman layanan, filter portfolio, alur quote WhatsApp, kontak/lokasi, dan video hero produksi.', focus: ['Vanilla HTML/CSS/JavaScript', 'Tailwind CDN', 'Arsitektur MPA statis', 'Alur quote WhatsApp', 'Galeri portfolio + lightbox', 'Leaflet map', 'Metadata SEO lokal'], impact: ['Mengganti pola cart dan checkout palsu dengan alur konsultasi yang nyata', 'Membangun halaman layanan, portfolio, about, dan contact', 'Membuat pesan quote WhatsApp terstruktur tanpa backend storage', 'Meningkatkan trust lewat alamat, jam buka, map, logo klien, favicon set, schema metadata, dan video produksi'] },
